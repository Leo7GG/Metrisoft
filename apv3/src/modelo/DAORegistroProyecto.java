...
public class DAORegistroProyecto {
		 ...
		 * @param clienteAlta
		 */
		public DAORegistroProyecto() {
			// TODO Auto-generated constructor stub
			conexion = new DAOConexion();
		}
		public DAORegistroProyecto(Integer tarifa, String nombre, String descr,
		...
		public DAORegistroProyecto(Integer id, Integer tarifa, String nombre,
		...
		public static void consultarInformacionProyectos(Connection con, ObservableList<DAORegistroProyecto> listaProyecto){
				try {
					...
					while (rs.next()) {
						listaProyecto.add(new DAORegistroProyecto(
		...
		public static void consultarInformacionProyectosEliminados(Connection con, ObservableList<DAORegistroProyecto> listaProyecto){
			try {
